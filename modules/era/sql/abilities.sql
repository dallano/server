...
REPLACE INTO `abilities` (`abilityId`, `name`, `job`, `level`, `validTarget`, `recastTime`, `recastId`, `message1`, `message2`, `animation`, `animationTime`, `castTime`, `actionType`, `range`, `isAOE`, `CE`, `VE`, `meritModID`, `addType`, `content_tag`) VALUES
    ...
    (88, 'assault', 15, 1, 4, 5, 170, 0, 0, 94, 2000, 0, 6, 18.0, 0, 0, 0, 0, 256, NULL),
    ...
    (250, 'avatars_favor', 15, 55, 1, 300, 176, 100, 0, 94, 2000, 0, 6, 10.0, 0, 1, 80, 0, 0, 'WOTG'),
    ...
    (389, 'consume_mana', 8, 55, 1, 60, 373, 0, 0, 337, 2000, 0, 6, 20.0, 0, 1, 1300, 0, 0, NULL),
    ...
    (393, 'spirit_bond', 14, 65, 1, 60, 149, 100, 0, 86, 2000, 0, 6, 18.0, 0, 0, 0, 0, 0, 'SOA'),
    (394, 'majesty', 7, 70, 1, 60, 150, 100, 0, 338, 2000, 0, 6, 0.0, 0, 0, 340, 0, 0, 'SOA'),
    ...
    (714, 'sand_blast', 9, 25, 257, 1, 102, 0, 0, 0, 2000, 0, 6, 18.0, 0, 1, 60, 902, 0, NULL),
    (715, 'sand_pit', 9, 25, 257, 2, 102, 0, 0, 0, 2000, 0, 6, 18.0, 0, 1, 60, 902, 0, NULL),
