...
xi.settings.main =
{
    ...
    MAGIAN_TRIALS_MOBKILL_MULTIPLIER = 0,
    MAGIAN_TRIALS_TRADE_MULTIPLIER   = 0,
    ...
    START_GIL                      = 350, -- Amount of gil given to newly created characters.
    ...
    COFFER_MAX_ILLUSION_TIME = 60,  -- 1 minute
    COFFER_MIN_ILLUSION_TIME = 60,  -- 1 minute
    CHEST_MAX_ILLUSION_TIME  = 60,  -- 1 minute
    ...
    -- DYNAMIS SETTINGS
    BETWEEN_2DYNA_WAIT_TIME     = 21,       -- Hours before player can re-enter Dynamis. Default is 1 Earthday (24 hours).
    ...
    DIG_FATIGUE                  = 0,   -- Set max amount of items a player can dig every 24 hours. Set to 0 to disable.
