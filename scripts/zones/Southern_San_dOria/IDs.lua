...
zones[xi.zone.SOUTHERN_SAN_DORIA] =
{
    text =
    {
        ...
        RAIMBROY_DIALOG                = 7855,  -- Greetings, and welcome to Raimbroy's Grocery. If you'd like to make a purchase, talk to someone at the counter upstairs.
        REVIVAL_TREE_ROOT              = 7883,  -- Go to King Ranperre's Tomb and bring back Revival Tree Root...
        TAUMILA_DEFAULT                = 7989,  -- I am Taumila, the owner of this establishment. Talk to the lady behind the counter if you wish to make a purchase.
        ...
        WAY_OF_THE_SWORD               = 8029,  -- The way of the sword is the way of action! Now, go!
        ...
        MALECHARISANT_DIALOG           = 8197,  -- You stand before the Westgate. West Ronfaure lies beyond.
        ...
        BENAIGE_SHOP_DIALOG            = 8450,  -- Looking for something in particular?
