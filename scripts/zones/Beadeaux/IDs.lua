...
zones[xi.zone.BEADEAUX] =
{
    text =
    {
        ...
        GLITTERING_FRAGMENT_STOLEN         = 7769, -- The <item> is taken from you!
    ...
    mob =
    {
        ...
        DA_DHA_HUNDREDMASK_PH  =
        {
            ...
            [17379429] = 17379427, -- -182.120 0.500 -124.217
            [17379432] = 17379427, -- -182.830 0.500 -123.990
        },
        GE_DHA_EVILEYE_PH      =
        {
    ...
    {
        QM1             = 17379801,
        TREASURE_CHEST  = 17379843,
        TREASURE_COFFER = 17379844,
