...
zones[xi.zone.VALKURM_DUNES] =
{
    text =
    {
        ...
        RETURN_TO_SEA                  = 7811,  -- You return the <item> to the sea.
        TOO_MANY_IN_PARTY              = 7831,  -- Nothing happens. Your party exceeds the maximum number of <number> members.
        ALLIANCE_NOT_ALLOWED           = 7832,  -- Nothing happens. You must dissolve your alliance.
        ...
        SHIMMERY_POINT                 = 7839,  -- Right over there! The ship-shape-shimmery point!
        HURRY_UP                       = 7840,  -- Ahhhh! Hurry up, hurry up!!!
        ITS_COMING                     = 7841,  -- It's coming! It's coming for ussssss!
        THREE_OF_THEM                  = 7842,  -- It can'taru be....!Three of them!!!?
        NOOOOO                         = 7843,  -- Noooooo!!!!
        CRY_OF_ANGUISH                 = 7844,  -- ??? disappears in a cry of anguish.
        NO_LONGER_FEEL_CHILL           = 7849,  -- You no longer feel a chill. The chart may lose its power if you venture too far.
        TOO_MUCH_TIME_PASSED           = 7850,  -- Too much time has passed. The monster has lost interest.
