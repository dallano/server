...
zones[xi.zone.SOUTH_GUSTABERG] =
{
    text =
    {
        ...
        SMILEBRINGER_START            = 11048, -- So, are you ready-steady? Beginner level training...GO! Come on, pump those legs like there's no tomorrow!
        SMILEHELPER_CHECKPOINT_1      = 11070, -- Checkpoint <number> cleared, Elasped time: [minutes], [seconds]
        SMILEHELPER_CHECKPOINT_2      = 11071, -- Checkpoint <number> cleared! You gain the effect of Flee. Elasped time: [minutes], [seconds]
        SMILEHELPER_ALREADY_VISITED   = 11072, -- You have already cleared this checkpoint. Elapsed time: [minutes], [seconds]
        SMILEHELPER_POINTS_CLEARED    = 11074, -- All checkpoints cleared! Please report back to the smile sergeant in charge.
        SMILEHELPER_IDLE              = 11076, -- This is a checkpointaru for the Smilebringer Boot camp. To learny-wearn more, please speak with the smile sergeant posted by the town entrance.
    },
    mob =
    {
        CARNERO_PH       =
