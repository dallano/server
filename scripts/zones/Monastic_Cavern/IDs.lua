...
zones[xi.zone.MONASTIC_CAVERN] =
{
    text =
    {
        ...
        ALTAR                         = 7275, -- This appears to be an altar.
        THE_MAGICITE_GLOWS_OMINOUSLY  = 7278, -- The magicite glows ominously.
        CHEST_UNLOCKED                = 7297, -- You unlock the chest!
        ORCISH_OVERLORD_ENGAGE        = 7309, -- Intruders? Get outs here! We gots us some adventurers!
        ORCISH_OVERLORD_DEATH         = 7310, -- Gahahahaha... You fell for our trick. I'm not the big boss. He don't need to be troubled by runty little rarabs like you.
