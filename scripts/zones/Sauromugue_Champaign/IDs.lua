...
zones[xi.zone.SAUROMUGUE_CHAMPAIGN] =
{
    text =
    {
        ...
        MANY_TIGER_BONES              = 7241,  -- There are many tiger bones here...
        OLD_SABERTOOTH_DIALOG_I       = 7247,  -- You hear the distant roar of a tiger. It sounds as if the beast is approaching slowly...
        OLD_SABERTOOTH_DIALOG_II      = 7248,  -- The sound of the tiger's footsteps is growing louder.
        ...
        THF_AF_MOB                    = 7426,  -- Something has come down from the tower!
        THF_AF_WALL_OFFSET            = 7445,  -- It is impossible to climb this wall with your bare hands.
        ...
        VOIDWALKER_DESPAWN            = 7546,  -- The monster fades before your eyes, a look of disappointment on its face.
        UNITY_WANTED_BATTLE_INTERACT  = 7577,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        REGIME_REGISTERED             = 9816,  -- New training regime registered!
        VOIDWALKER_NO_MOB             = 10989, -- The <keyitem> quivers ever so slightly, but emits no light. There seem to be no monsters in the area.
        VOIDWALKER_MOB_TOO_FAR        = 10990, -- The <keyitem> quivers ever so slightly and emits a faint light. There seem to be no monsters in the immediate vicinity.
        VOIDWALKER_MOB_HINT           = 10991, -- The <keyitem> resonates [feebly/softly/solidly/strongly/very strongly/furiously], sending a radiant beam of light lancing towards a spot roughly <number> [yalm/yalms] [east/southeast/south/southwest/west/northwest/north/northeast] of here.
        VOIDWALKER_SPAWN_MOB          = 10992, -- A monster materializes out of nowhere!
        VOIDWALKER_UPGRADE_KI_1       = 10994, -- The <keyitem> takes on a slightly deeper hue and becomes <keyitem>!
        VOIDWALKER_UPGRADE_KI_2       = 10995, -- The <keyitem> takes on a deeper, richer hue and becomes <keyitem>!
        VOIDWALKER_BREAK_KI           = 10996, -- The <keyitem> shatters into tiny fragments.
        VOIDWALKER_OBTAIN_KI          = 10997, -- Obtained key item: <keyitem>!
