...
zones[xi.zone.DYNAMIS_TAVNAZIA] =
{
    text =
    {
        ...
        I_AM_A_UNIQUE_ENTITY          = 7385, -- I am...a unique entity...
        COMPRISED_OF_ALL_ENTITIES     = 7386, -- We are...comprised of all entities...
        INTERMINGLING_DIVIDING        = 7387, -- Intermingling with one another...dividing among each other...
        DEVOURING_ONE_ANOTHER         = 7388, -- Devouring one another...
        NOW_I_WILL_JOIN_THEM          = 7389, -- Now I will join them...
    },
    mob =
    {
        TIME_EXTENSION =
