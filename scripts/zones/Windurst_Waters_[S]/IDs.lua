...
zones[xi.zone.WINDURST_WATERS_S] =
{
    text =
    {
        ...
        PELFTRIX_SHOP_DIALOG          = 7211,  -- Boodlix's Emporium open for business! Boodlix's gots whats you wants, at the price yous likes! It's okay, we takes yours gils, too!
        MOG_LOCKER_OFFSET             = 7476,  -- Your Mog Locker lease is valid until <timestamp>, kupo.
        REGIME_CANCELED               = 7746,  -- Current training regime canceled.
        HUNT_ACCEPTED                 = 7764,  -- Hunt accepted!
        USE_SCYLDS                    = 7765,  -- You use <number> [scyld/scylds]. Scyld balance: <number>.
        HUNT_RECORDED                 = 7776,  -- You record your hunt.
        OBTAIN_SCYLDS                 = 7778,  -- You obtain <number> [scyld/scylds]! Current balance: <number> [scyld/scylds].
        HUNT_CANCELED                 = 7782,  -- Hunt canceled.
        HOMEPOINT_SET                 = 10877, -- Home point set!
        YASSI_POSSI_DIALOG            = 10897, -- Swifty-wifty and safey-wafey parcel delivery! Is there something you need to send?
        EZURAROMAZURA_SHOP_DIALOG     = 10898, -- A potent spelly-well or two can be the key to survival in this time of war. But can you mastaru my magic, or will it master you?
        DOOR_ACOLYTE_HOSTEL_LOCKED    = 11340, -- The door appears to be locked...
