...
zones[xi.zone.RABAO] =
{
    text =
    {
        ...
        LUCKY_ROLL_EXACT              = 10328, -- And because your roll put the running total at exactly 400, you receive a bonus prize!
    ...
    npc =
    {
        MILEON       = 17788988, -- Lucky Roll Npc
        GOLDFISH_NPC = 17789026,
    },
}
