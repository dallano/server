...
zones[xi.zone.UPPER_DELKFUTTS_TOWER] =
{
    text =
    {
        ...
        PLAYER_OBTAINS_ITEM           = 7385,  -- <name> obtains <item>!
        UNABLE_TO_OBTAIN_ITEM         = 7386,  -- You were unable to obtain the item.
        PLAYER_OBTAINS_TEMP_ITEM      = 7387,  -- <name> obtains the temporary item: <item>!
        ALREADY_POSSESS_TEMP          = 7388,  -- You already possess that temporary item.
        NO_COMBINATION                = 7393,  -- You were unable to enter a combination.
        REGIME_REGISTERED             = 9471,  -- New training regime registered!
        LEARNS_SPELL                  = 10519, -- <name> learns <spell>!
