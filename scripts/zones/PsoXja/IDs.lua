...
zones[xi.zone.PSOXJA] =
{
    text =
    {
        ...
        DEVICE_IN_OPERATION           = 7241, -- The device appears to be in operation...
        DOOR_LOCKED                   = 7244, -- The door is locked.
        ARCH_GLOW_BLUE                = 7245, -- The arch above the door is glowing blue...
        ARCH_GLOW_GREEN               = 7246, -- The arch above the door is glowing green...
        CANNOT_OPEN_SIDE              = 7249, -- The door cannot be opened from this side.
        TRAP_ACTIVATES                = 7251, -- <name> examines the door. A trap connected to it has been activated!
        TRAP_FAILS                    = 7252, -- <name> examines the door. The trap connected to it fails to activate.
