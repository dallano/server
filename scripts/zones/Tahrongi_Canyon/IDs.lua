...
zones[xi.zone.TAHRONGI_CANYON] =
{
    text =
    {
        ...
        TELEPOINT_HAS_BEEN_SHATTERED  = 7516,  -- The telepoint has been shattered into a thousand pieces...
        SPROUT_LOOKS_WITHERED         = 7559,  -- There is something sprouting from the ground here. It looks a little withered.
        REPULSIVE_CREATURE_EMERGES    = 7560,  -- A repulsive creature emerges from the ground!
        SPROUT_DOES_NOT_NEED_WATER    = 7561,  -- The sprout does not need any more water now.
        NOTHING_HAPPENS               = 7562,  -- Nothing happens.
        SPROUT_LOOKING_BETTER         = 7563,  -- The sprout is looking better.
        ...
        VOIDWALKER_DESPAWN            = 7607,  -- The monster fades before your eyes, a look of disappointment on its face.
